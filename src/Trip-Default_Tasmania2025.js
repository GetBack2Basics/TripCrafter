...
const defaultTasmaniaTripData = [
  ...
  title: 'Spirit of Tasmania (Sailing 1)',
    status: 'Booked',
  ...
  title: 'Scamander Sanctuary Holiday Park',
    status: 'Booked',
  notes: 'Booking for George Corea (24 Dec 2025 to 25 Dec 2025). Booking #27366. Receipt #29582. Scenic drive from Bay of Fires to Tasmania\'s East Coast for Christmas.',
  ...
  title: 'Cethana Campground (Base)', // Base camp
  ...
  title: 'Devonport Hotel or Ferry',
    status: 'Not booked',
  ...
  title: 'Spirit of Tasmania (Sailing 2)',
    status: 'Booked',
